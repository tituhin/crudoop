        ...
        <div class="form-group col-6 mx-auto">
            <form action="<?=$_SERVER['PHP_SELF']?>" method="post">
                ...
                <input class="form-control" type="number" step="0.1" min="1" max="5"id="rating" name="rating"
                       value=<?=(int)$book['rating']?>>

                <label for="publication">Publish</label><br>
                <input class="form-control" type="date" id="date" name="publish_date" value=<?=(int)$book['publish_date'] ?>> <br>

                <label class="details" for="subject">Subject</label>
                <textarea id="subject" name="details" placeholder="Write something.." class="form-control"
                          ><?=$book['details'] ?>
                </textarea>
